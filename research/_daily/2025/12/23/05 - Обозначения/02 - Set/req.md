# `᛭T`
##
Перечисли мне `AA`: 50 символов Unicode, которыми можно кратко обозначить понятие «set» из https://en.wikipedia.org/wiki/Set_(mathematics)
##
...
##
Можно предлагать буквы редких алфавитов, визуально похожих на `S`. 
##
