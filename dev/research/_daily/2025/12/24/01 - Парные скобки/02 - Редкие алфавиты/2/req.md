...
# 2. `G↑`
Мне нужны `QQ`: пары необычных символов, зеркальных относительно друг друга, которые можно использовать как парные скобки.
## Пример:
`ᐸ` и `ᐳ`.
...
Особенно там, где на самом деле `QQ` — это не скобки, а лишь пары зеркальных символов, которые внешне похожи на скобки.
