#
`P` ≔ ⟨ «Proposition» в контексте https://en.wikipedia.org/wiki/Proposition ⟩ 

#
`M` ≔ ⟨ «Meaning» в контексте https://en.wikipedia.org/wiki/Meaning_(philosophy) ⟩ 


# `᛭T`
Объясни разницу между `P` и `M`.
