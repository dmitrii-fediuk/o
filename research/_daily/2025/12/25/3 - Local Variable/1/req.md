...
#
`LV` ≔ https://en.wikipedia.org/wiki/Local_variable

#
`LL` ≔ ⟨ Языки описания онтологий ⟩  

# `᛭T`
Проанализируй 10 самых популярных `LL`: как там используются `LV`.
- Каков синтаксис / обозначения для `LV`
- Каковы особенности применения `LV`
