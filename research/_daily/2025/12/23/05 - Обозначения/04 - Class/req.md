# `᛭T`
##
Перечисли мне `AA`: 50 символов Unicode, которыми можно кратко обозначить понятие «Class» из https://en.wikipedia.org/wiki/Class_(knowledge_representation) / https://en.wikipedia.org/wiki/Ontology_components#Classes
##
...
##
Можно предлагать буквы редких алфавитов, визуально похожих на `C`. 
##
