...
###
Вне §P это обозначение не действительно: в частности, если до §P обозначение `A` имело другой смысл, то после §P обозначение `A` снова будет иметь этот смысл.
###
По сути, `A` — это локальная переменная с областью действия §P.
