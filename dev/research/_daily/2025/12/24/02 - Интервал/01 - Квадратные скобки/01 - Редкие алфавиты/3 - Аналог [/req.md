...
# 2. `G↑`
##
Мне нужен `Q`: необычный символ, который внешне похожи на открывающую квадратную скобку (`[`).
## Примеры (их не предлагай заново)
`⣏`, `匚`, `ⵎ`
...
- Разные технические и исторические символы
- Символы Брайля
- Буквы популярных европейских алфавитов (латиница, кириллица и т.п.)

# 
Не предлагай более 2 символов из одного и того же алфавита.

## 
Предлагай только символы редких алфавитов или иероглифы.
Особенно там, где на самом деле `Q` — это семантически не скобка, а лишь внешне похож на `[`.
