...
# 2. `G↑`
##
Мне нужны `QQ`: пары необычных символов, зеркальных относительно друг друга, которые внешне похожи на квадратные скобки.
## Пример (его не предлагай заново)
`⣏ ⣹`

##
Я буду использовать `QQ` для синтаксиса `𝕀` в `᛭L`.
...
Особенно там, где на самом деле `QQ` — это не скобки, а лишь пары зеркальных символов, которые внешне похожи на квадратные скобки.
