# `᛭T`
##
Перечисли мне `AA`: 50 символов Unicode, которыми можно кратко обозначить понятие «тип» из https://en.wikipedia.org/wiki/Type_theory
##
...
##
Можно предлагать буквы редких алфавитов, визуально похожих на `T`. 
##
