#
`U` ≔ `https://en.wikipedia.org/wiki/Partially_ordered_set#Intervals`

#
`P` ≔ `Partially_ordered_set#Intervals`

# `᛭T`
##
Как по-правильному на английском языке называется часть URL `P` относительно `U`?
##
