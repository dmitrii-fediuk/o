...
`𐒌⁎` ≔ 
```
Я хочу доработать пункты 3-5 раздела IV `A3ᨀ`.
В частности, я хочу добавить отсылки к концепции «чёрного лебедя».
Сейчас я пишу про сантехника, а неплохо было бы писать про юриспруденцию и ракетостроение.
Показать, почему fix price там — это плохо, к каким проблемам это приводит.
Хорошо бы привести реальные яркие кейсы из юриспруденции и ракетостроения.
Вообще, мне кажется, что основная цель юридических документов — это как раз защита на случай «чёрных лебедей».
Неплохо было бы указать, что многие из опасностей, которые поджидают клиента как стартапера, если вдруг случайно его компания станет успешной (что для любого стартапа уже маловероятно) — это как раз юридические пробелемы. Подобрать яркие исторические кейсы. 
```
